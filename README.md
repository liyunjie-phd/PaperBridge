...
> 示意图使用单独授权的模板项目，不包含未公开论文内容。

## 基础配置

### 1. 启动 PaperBridge

Windows 只提供一个完整安装版：`PaperBridge-Setup.exe`[下载 PaperBridge Windows 安装程序](https://github.com/liyunjie-phd/PaperBridge/releases/latest/download/PaperBridge-Setup.zip)。
